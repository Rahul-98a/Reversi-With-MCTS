...
public class Game
{
  ...
  private static String play_game() 
  {
    ...
    System.out.println("The MCTS AI is player O");
    System.out.println("The board is labelled 0-63, from left-to-right, top-to-bottom");
    ...
    while(true) 
    {
      ...
      {
        ai_has_move = true;
        System.out.println("Possible Moves for MCTS AI (Player O): " + possible_moves);
        System.out.println("MCTS AI making move... ");
        ...
        System.out.println("MCTS AI choosing move at tile " + new_tile);
      ...
      else 
      {
        ...
        System.out.println("Possible Moves for you (Player X): " + possible_moves);
        System.out.println("Player " + current_player + ", choose a spot from 1-" + possible_moves.size() + ":");
        
        boolean valid_move = false;
        int move = sc.nextInt();
        int new_tile = possible_moves.get(move-1);
        board = make_move(current_player, board, new_tile);   
        System.out.println();
        System.out.println();
      }
